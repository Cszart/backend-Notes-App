...
export class CategoriesController {
  ...
  @Put(':id')
  async updateCategory(@Param('id') id: number, @Body() noteData: CategoryI): Promise<Observable<CategoryI>> {
    return await this.categorieService.updateCategory(id, noteData);
  }
